...
<html>
	...
	<form id="mainForm" action="role.action" method="get">
		...
		<table align="center" border="0" cellpadding="0"
			...
			<tr>
				<td align="left">
					<input type='button' onclick="addNew('role!input.action')" class='button_70px' value='新建'/>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<s:iterator value="page.result">
				<tr>
					...
					<td class="td_list_2" align=left nowrap>
						<a href="role!delete.action?id=${id }" class="btnDel" title="删除" onclick="return confirmDel();">删除</a>
						<a href="role!input.action?id=${id }" class="btnEdit" title="编辑">编辑</a>
						<a href="role!input.action?id=${id }" class="btnView" title="查看">查看</a>
					</td>
				</tr>
			</s:iterator>
			<frame:page exportUrl="role!export.action" curPage="${page.pageNo}" totalPages="${page.totalPages }" totalRecords="${page.totalCount }" lookup="${lookup }"/>
		</table>
	</form>
	</body>
</html>
